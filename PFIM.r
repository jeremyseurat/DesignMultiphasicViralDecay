...
directory<-"C:/Users/Jeremy/Documents/postdoc/DesignProjects/ViralDecay/PFIMloops" #where is located the stdin
directory.program<-"C:/Users/Jeremy/Documents/travaux/PFIM/PFIM4.0/Program" #where is located the PFIM Program directory
