...
#-----------------------------------------------------------------
protA<-list(c(0, 0.5, 1, 2, 6, 9, 12, 24, 36, 48, 72, 96, 120))
...
sampwinA<-list(c(0, 0.5, 1, 2, 6, 9, 12, 24, 36, 48, 72, 96, 120))
